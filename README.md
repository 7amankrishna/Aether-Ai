...
📥 Download • ✨ Features • 🤖 Supported Models • 🚀 Getting Started • 🛠 Build From Source
</div>
---
🌌 What is Aether AI?
...
📥 Download
<div align="center">
⬇️ Download Aether AI v1.0 (APK)
![Direct APK](https://img.shields.io/badge/Direct%20APK-v1.0-3DDC84?logo=android&logoColor=white&style=for-the-badge)
...
---
🚀 Getting Started
Install Aether AI (see Download)
Sign in to create your account
Open Settings → AI Providers and paste an API key for any provider:
Anthropic → console.anthropic.com
OpenAI → platform.openai.com
Gemini → aistudio.google.com (free tier)
Groq → console.groq.com (free tier)
OpenRouter → openrouter.ai
Pick your model and start chatting — Opus 4.8 on a smartphone, no laptop required
(Optional) Connect Google Drive for document auto-organization
---
🛠 Build From Source
Prerequisites: Android Studio (latest), JDK 17
```bash
git clone https://github.com/7amankrishna/Aether-Ai.git
cd Aether-Ai
```
Open the project in Android Studio and let Gradle sync
Copy `.env.example` → `.env` and add your `GEMINI_API_KEY` (used as the default provider)
Add your own `google-services.json` if you use your own Firebase project
Run on an emulator or physical device ▶️
Tech Stack
